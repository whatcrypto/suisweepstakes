...
import { getAdapter } from "../app/misc/adapter";
import ActionStarryButton from "./StarryButton/ActionStarryButton";
import StarryButton from "./StarryButton/StarryButton";
              ...
              <ActionStarryButton
                onClick={async () => {
                  const signTransaction = async () => {
                    ...
                    const coin = transactionBlock.splitCoins(
                    ...
                    toast.success("Transaction send!", {
                      action: {
                        ...
                        onClick: () => {
                          ...
                          window.open(
                            `https://suiscan.xyz/mainnet/tx/${txid.digest}`,
                            "_blank"
                          );
                        },
                      },
